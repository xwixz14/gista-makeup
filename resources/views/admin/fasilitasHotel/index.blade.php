...
@section('content')
    <div class="content-wrapper">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-0">Paket MakeUp Gista</h4>
                        ...
                        <table class="table table-bordered" style="table-layout: fixed; width: 100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <img src="{{ asset('storage/' . $row->image) }}" alt="Fasilitas Hotel" style="border-radius: 0; height: 100px; width: 100px;"> </td>
                                    <td>
